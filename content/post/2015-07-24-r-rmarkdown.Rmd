...
date: 2020-09-28T01:10:00-5:00
output:
  html_document: default
  pdf_document: default
abstract: In this report, we preliminarily investigate whether subsidizing low-income childcare for age 0-5 children can meaningfully improve long-term educational outcomes (as measured by grade 9 graduation rates).
---
...
A question involving assistive funding for early-aged children is whether subsidized child-care can improve long-term educational outcomes. If there is, then educational decision makers may wish to further fund early-level childcare. If there isn't, then purely educational funding may be better directed towards other facilities and services.
...
Let us first inspect the Toronto Youth Education dataset.
